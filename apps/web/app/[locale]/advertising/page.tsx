...
export default async function AdvertisingDisclosurePage(props: {
  ...
  return (
    <SiteLegalPage locale={locale} title="广告与联盟披露">
      ...
      <p className="text-sm text-neutral-600 dark:text-neutral-400">
        <Link className="underline" href={localePath(locale, "/about")}>
          返回关于本站
        </Link>
      </p>
    </SiteLegalPage>
